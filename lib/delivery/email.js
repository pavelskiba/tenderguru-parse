...
function buildTransport() {
  ...
  return nodemailer.createTransport({
    ...
    // Railway часто не маршрутизирует исходящий IPv6, а Node по умолчанию
    // пробует его первым — TCP SYN уходит в никуда и соединение висит до
    // таймаута. Принудительный IPv4 убирает эту задержку.
    family: 4,
  });
}
